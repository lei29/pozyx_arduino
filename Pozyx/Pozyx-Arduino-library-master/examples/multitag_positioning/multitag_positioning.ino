...
uint16_t tags[num_tags] = {0x6746, 0x6972, 0x6745};

boolean use_processing = false;                         // set this to true to output data for the processing sketch

const uint8_t num_anchors = 4;                                    // the number of anchors
uint16_t anchors[num_anchors] = {0x6e67, 0x6e74, 0x6e77, 0x6925};     // the network id of the anchors: change these to the network ids of your anchors.
int32_t anchors_x[num_anchors] = {0, 0, 5560, 5560};               // anchor x-coorindates in mm
int32_t anchors_y[num_anchors] = {0, 6120, 6120, 0};                  // anchor y-coordinates in mm
int32_t heights[num_anchors] = {1400, 2160, 1730, 2340};              // anchor z-coordinates in mm
